...
**核心原则**：Apple 级体验 > 视觉完美 > 性能极致 > 代码优雅 > 充足地在大量位置&功能允许外部自定义实现/增强/扩展
**强制规则**：必须完全遵守hexo主题开发规范 设计原则(https://hexo.io/zh-cn/docs/)，所有的代码必须遵循以下规则，否则将无法通过 CI 检测
**插件选择**：如 https://hexo.io/plugins/ 下有合适当前主题规则的情况下优先使用，没有的情况下才允许自定义实现
---
